    ...
    protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (authenticationManager.User.IsInRole("Customer"))
            {
                ...
                this.dataProductsGrid.Columns[6].Visible = false;
            }
            else if (authenticationManager.User.IsInRole("Admin"))
            {
                ...
                dataProductsGrid.AutoGenerateDeleteButton = true;
                this.dataProductsGrid.Columns[7].Visible = true;
        ...
        protected void OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            pe.ProductName = viewRow.Cells[3].Text;
            pe.ProductDescription = viewRow.Cells[4].Text;
            pe.ProductPrice = viewRow.Cells[6].Text;
